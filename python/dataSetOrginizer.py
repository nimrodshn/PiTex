...
class dataSetOrginizer:
    ...
    def createDefaultTrainingSet(self):
        '''
        Creates the Default Training Model
        :return: Void
        '''

        address = "..//data//training//Default"
        labels = []
        trainingData = []
        classes = []
        cl = 0
    ...
    def createNewTrainingSet(self, name, location=''):
        '''
          Creats a new training set to work on
