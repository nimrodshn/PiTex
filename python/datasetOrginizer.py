...
class datasetOrginizer:
    ...
    def createRegressionTrainingFromDataset(self, dataset_name, labels_list, path):
        '''
        ...
        np.savez(os.path.join(base_path, dataset_name), B, labels_list, classes,  min_max_features)
